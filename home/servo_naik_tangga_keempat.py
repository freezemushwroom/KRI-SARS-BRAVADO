...
for i in range (10, 41, 1):
    ...
    kit1.servo[1].angle = 80 + i #femur3
    kit1.servo[0].angle = 90 + (i-10)#tibia3
    kit2.servo[11].angle = 65 - (i+5)#femur5
    kit2.servo[12].angle = 55 - (i-15)#tibia5
...
try:
    while True:
        ...
        for i in range(10,41,1):
            kit1.servo[4].angle = 120 + (i+20)#femur2
            kit1.servo[3].angle = 125 + (i+15)#tibia2
            kit2.servo[14].angle = 100 - i #femur4
            kit2.servo[15].angle = 95 - (i-10)#tibia4
        ...
        for i in range (10, 31, 1):
            ...
            kit2.servo[13].angle = 110 - i #coxa4
        ...
        for i in range ( 10, 41, 1):
            ...
            kit1.servo[1].angle = 80 + i #femur3
            kit1.servo[0].angle = 90 + (i-10)#tibia3
            kit2.servo[11].angle = 65 - (i+25)#femur5
            kit2.servo[12].angle = 55 - (i+15)#tibia5
        print("Femur 1 3 5 Ngangkat")
        sleep(waktu_sleep)
