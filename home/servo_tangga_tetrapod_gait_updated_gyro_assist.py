...
try:
    while True:
        ...
        # FIXED: Catch all three variables explicitly
        base_coxa_tengah_berdiri, coxa_femur_tengah_berdiri, femur_tibia_tengah_berdiri = IK_tengah(0, 0, 0, current_roll, 0)
