...
try:
    while True:
        #coxa 1 dan 6 maju sisanya mundur
        idx[0] = 0
        idx[5]= 0
        decrement(0, 5)
        ...
        print("Coxa 1 dan 6 Maju dari posisi berdiri, sisanya mundur")
        sleep(waktu_sleep)

        #femur 1 dan 6 turun dan tibia turun sekalian adjust ngambil kaki
        ...
        print("Femur Tibia 1 dan 6 Turun")
        sleep(waktu_sleep)

        #femur 3 dan45 angkat
        kit1.servo[1].angle = 170 #femur3
        kit1.servo[0].angle = 180 #tibia3
        kit2.servo[14].angle = 10 #femur4
        kit2.servo[15].angle = 0 #tibia4
        print("Femur 3 dan 4 Ngangkat")
        sleep(waktu_sleep)

        #coxa 3 dan 4 maju sisanya mundur
        idx[2] = 0
        idx[3] = 0
        decrement(2, 3)
        ...
        print("Coxa 3 dan 4 Maju dari posisi berdiri, sisanya mundur")
        sleep(waktu_sleep)
        ...
        print("Femur Tibia 2 dan 5 Angkat")
        sleep(waktu_sleep)

        #coxa 2 dan 5 maju sisanya mundur
        idx[1] = 0
        idx[4] = 0
        decrement(1, 4)
        ...
        print("Coxa 2 dan 5 Maju dari posisi berdiri, sisanya mundur")
        sleep(waktu_sleep)
